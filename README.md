...
> *A sleep meditation app. Zero friction to sleep.*

A faithful **web prototype** of the [Drift product spec](./SPEC.md) (v1.0, June 2026) —
built to be visible, deployable, and **Android-ready** (see [ANDROID_PORTING.md](./ANDROID_PORTING.md)).
...
| §10 Onboarding (3 screens, no account) | ✅ `Onboarding.tsx` |
